$(document).ready(function(){
  ...
  var top_height_4 = top_height_3 + $("#img_title_3").outerHeight() + $("#content_3").outerHeight() + (pd_btm  * 2 );
  ...
  $(window).resize(function(){ 
    ...
    top_height_4 = top_height_3 + $("#img_title_3").outerHeight() + $("#content_3").outerHeight() + (pd_btm  * 2 );
    console.log(pd_btm);
